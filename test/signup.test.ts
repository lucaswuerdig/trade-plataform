...
// test("Não deve criar uma conta com email já utilizado", async () => {
//     const inputSignup = {
//         name: "John Doe",
//         email: "john.doe@gmail.com",
//         document: "97456321558",
...
//     const responseSignupAgain = await axios.post("http://localhost:3000/signup", inputSignup);
//     const outputSignupAgain = responseSignupAgain.data;
//     expect(responseSignupAgain.status).toBe(422);
//     expect(outputSignupAgain.error).toBe("Email already exists");
// });